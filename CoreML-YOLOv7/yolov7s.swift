...
class yolov7sInput : MLFeatureProvider {
...
@available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
class yolov7sOutput : MLFeatureProvider {
...
class yolov7s {
    ...
    class var urlOfModelInThisBundle : URL {
        ...
        return bundle.url(forResource: "yolov7s", withExtension:"mlmodelc")!
    }

    /**
        Construct yolov7s instance with an existing MLModel object.

        Usually the application does not use this initializer unless it makes a subclass of yolov7s.
        Such application may want to use `MLModel(contentsOfURL:configuration:)` and `yolov7s.urlOfModelInThisBundle` to create a MLModel object to pass-in.
    ...
    */
    ...
    /**
        Construct yolov7s instance by automatically loading the model from the app's bundle.
    */
    ...
    */
    ...
    /**
        Construct yolov7s instance with explicit path to mlmodelc file
        - parameters:
    ...
    */
    ...
    /**
        Construct yolov7s instance asynchronously with optional configuration.
    ...
    */
    ...
    class func load(configuration: MLModelConfiguration = MLModelConfiguration(), completionHandler handler: @escaping (Swift.Result<yolov7s, Error>) -> Void) {
    ...
    */
    @available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, *)
    class func load(configuration: MLModelConfiguration = MLModelConfiguration()) async throws -> yolov7s {
        return try await self.load(contentsOf: self.urlOfModelInThisBundle, configuration: configuration)
    }

    /**
        Construct yolov7s instance asynchronously with URL of the .mlmodelc directory with optional configuration.
    ...
    */
    @available(macOS 11.0, iOS 14.0, tvOS 14.0, watchOS 7.0, *)
    class func load(contentsOf modelURL: URL, configuration: MLModelConfiguration = MLModelConfiguration(), completionHandler handler: @escaping (Swift.Result<yolov7s, Error>) -> Void) {
        MLModel.load(contentsOf: modelURL, configuration: configuration) { result in
            switch result {
            case .failure(let error):
                handler(.failure(error))
            case .success(let model):
                handler(.success(yolov7s(model: model)))
            }
        }
    }
    ...
    */
    @available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, *)
    class func load(contentsOf modelURL: URL, configuration: MLModelConfiguration = MLModelConfiguration()) async throws -> yolov7s {
        let model = try await MLModel.load(contentsOf: modelURL, configuration: configuration)
        return yolov7s(model: model)
    }
    ...
    /**
        ...
        - parameters:
           - input: the input to the prediction as yolov7sInput

        - throws: an NSError object that describes the problem

        - returns: the result of the prediction as yolov7sOutput
    */
    func prediction(input: yolov7sInput) throws -> yolov7sOutput {
    ...
    /**
        ...
        - returns: the result of the prediction as yolov7sOutput
    */
    func prediction(input: yolov7sInput, options: MLPredictionOptions) throws -> yolov7sOutput {
        let outFeatures = try model.prediction(from: input, options:options)
        return yolov7sOutput(features: outFeatures)
    }
    ...
    /**
        ...
        - returns: the result of the prediction as yolov7sOutput
    */
    func prediction(image: CVPixelBuffer, iouThreshold: Double, confidenceThreshold: Double) throws -> yolov7sOutput {
        let input_ = yolov7sInput(image: image, iouThreshold: iouThreshold, confidenceThreshold: confidenceThreshold)
    ...
    /**
        ...
        - parameters:
           - inputs: the inputs to the prediction as [yolov7sInput]
           - options: prediction options 
        ...
        - returns: the result of the prediction as [yolov7sOutput]
    */
    func predictions(inputs: [yolov7sInput], options: MLPredictionOptions = MLPredictionOptions()) throws -> [yolov7sOutput] {
        let batchIn = MLArrayBatchProvider(array: inputs)
        let batchOut = try model.predictions(from: batchIn, options: options)
        var results : [yolov7sOutput] = []
        results.reserveCapacity(inputs.count)
        for i in 0..<batchOut.count {
            let outProvider = batchOut.features(at: i)
            let result =  yolov7sOutput(features: outProvider)
